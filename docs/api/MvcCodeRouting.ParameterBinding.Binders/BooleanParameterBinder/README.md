BooleanParameterBinder Class
============================
Binds [Boolean][1] route parameters.
...
    **MvcCodeRouting.ParameterBinding.Binders.BooleanParameterBinder**  
...
The **BooleanParameterBinder** type exposes the following members.
...
Name                        | Description                                                        
--------------------------- | ------------------------------------------------------------------ 
[BooleanParameterBinder][5] | Initializes a new instance of the **BooleanParameterBinder** class 
...
Name               | Description                                                                              
------------------ | ---------------------------------------------------------------------------------------- 
[ParameterType][8] | Returns the [Type][9] for [Boolean][1]. (Overrides [ParameterBinder.ParameterType][10].) 
