UInt32ParameterBinder.TryBind Method
====================================
...
The bound value, an instance of [UInt32][5].
...
[5]: http://msdn.microsoft.com/en-us/library/ctys3981
