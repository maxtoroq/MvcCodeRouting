Int16ParameterBinder Class
==========================
Binds [Int16][1] route parameters.
...
    **MvcCodeRouting.ParameterBinding.Binders.Int16ParameterBinder**  
...
The **Int16ParameterBinder** type exposes the following members.
...
Name                      | Description                                                      
------------------------- | ---------------------------------------------------------------- 
[Int16ParameterBinder][5] | Initializes a new instance of the **Int16ParameterBinder** class 
...
Name               | Description                                                                            
------------------ | -------------------------------------------------------------------------------------- 
[ParameterType][8] | Returns the [Type][9] for [Int16][1]. (Overrides [ParameterBinder.ParameterType][10].) 
