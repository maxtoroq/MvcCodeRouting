ByteParameterBinder Class
=========================
Binds [Byte][1] route parameters.
...
    **MvcCodeRouting.ParameterBinding.Binders.ByteParameterBinder**  
...
The **ByteParameterBinder** type exposes the following members.
...
Name                     | Description                                                     
------------------------ | --------------------------------------------------------------- 
[ByteParameterBinder][5] | Initializes a new instance of the **ByteParameterBinder** class 
...
Name               | Description                                                                           
------------------ | ------------------------------------------------------------------------------------- 
[ParameterType][8] | Returns the [Type][9] for [Byte][1]. (Overrides [ParameterBinder.ParameterType][10].) 
