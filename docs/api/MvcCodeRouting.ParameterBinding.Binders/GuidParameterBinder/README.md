GuidParameterBinder Class
=========================
Binds [Guid][1] route parameters.
...
    **MvcCodeRouting.ParameterBinding.Binders.GuidParameterBinder**  
...
The **GuidParameterBinder** type exposes the following members.
...
Name                     | Description                                                     
------------------------ | --------------------------------------------------------------- 
[GuidParameterBinder][5] | Initializes a new instance of the **GuidParameterBinder** class 
...
Name               | Description                                                                           
------------------ | ------------------------------------------------------------------------------------- 
[ParameterType][8] | Returns the [Type][9] for [Guid][1]. (Overrides [ParameterBinder.ParameterType][10].) 
...
[1]: http://msdn.microsoft.com/en-us/library/cey1zx63
