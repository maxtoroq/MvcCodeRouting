SByteParameterBinder Class
==========================
Binds [SByte][1] route parameters.
...
    **MvcCodeRouting.ParameterBinding.Binders.SByteParameterBinder**  
...
The **SByteParameterBinder** type exposes the following members.
...
Name                      | Description                                                      
------------------------- | ---------------------------------------------------------------- 
[SByteParameterBinder][5] | Initializes a new instance of the **SByteParameterBinder** class 
...
Name               | Description                                                                            
------------------ | -------------------------------------------------------------------------------------- 
[ParameterType][8] | Returns the [Type][9] for [SByte][1]. (Overrides [ParameterBinder.ParameterType][10].) 
...
[1]: http://msdn.microsoft.com/en-us/library/f71b253d
