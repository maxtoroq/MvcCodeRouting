...
namespace MvcCodeRouting.Web.Routing {
   ...
   class CodeRoute : Route, ICodeRoute {
      ...
      public override VirtualPathData GetVirtualPath(RequestContext requestContext, RouteValueDictionary values) {
         ...
         RouteData requestRouteData = requestContext.RouteData;

         return this.DoGetVirtualPath(values, requestRouteData.Values, requestRouteData.DataTokens, () => base.GetVirtualPath(requestContext, values));
      }
   }
}
