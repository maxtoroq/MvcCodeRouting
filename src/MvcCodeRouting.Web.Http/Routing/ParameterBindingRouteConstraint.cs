...
namespace MvcCodeRouting.Web.Http.Routing {
   ...
   class ParameterBindingRouteConstraint : TypeAwareRouteConstraint {
      ...
      protected override bool TryParse(HttpRequestMessage request, string parameterName, object rawValue, string attemptedValue, CultureInfo culture, out object result) {
