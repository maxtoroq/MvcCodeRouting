...
namespace MvcCodeRouting.ParameterBinding.Binders {
   ...
   /// <summary>
   /// Binds <see cref="SByte"/> route parameters.
   /// </summary>
   public class SByteParameterBinder : ParameterBinder {

      /// <summary>
      /// Returns the <see cref="Type"/> for <see cref="SByte"/>.
      /// </summary>
      ...
      /// <param name="result">The bound value, an instance of <see cref="SByte"/>.</param>
