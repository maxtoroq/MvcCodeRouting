...
namespace MvcCodeRouting.ParameterBinding.Binders {
   ...
   /// <summary>
   /// Binds <see cref="UInt64"/> route parameters.
   /// </summary>
   public class UInt64ParameterBinder : ParameterBinder {

      /// <summary>
      /// Returns the <see cref="Type"/> for <see cref="UInt64"/>.
      /// </summary>
      ...
      /// <param name="result">The bound value, an instance of <see cref="UInt64"/>.</param>
      ...
      public override bool TryBind(string value, IFormatProvider provider, out object result) {
         ...
         if (!UInt64.TryParse(value, NumberStyles.None, provider, out parsedResult)) {
            return false;
         }
