...
namespace MvcCodeRouting.ParameterBinding.Binders {
   ...
   /// <summary>
   /// Binds <see cref="Double"/> route parameters.
   /// </summary>
   public class DoubleParameterBinder : ParameterBinder {
      ...
      /// <summary>
      /// Returns the <see cref="Type"/> for <see cref="Double"/>.
      /// </summary>
      ...
      /// <param name="result">The bound value, an instance of <see cref="Double"/>.</param>
