...
namespace MvcCodeRouting.ParameterBinding.Binders {
   ...
   /// <summary>
   /// Binds <see cref="Int64"/> route parameters.
   /// </summary>
   public class Int64ParameterBinder : ParameterBinder {

      /// <summary>
      /// Returns the <see cref="Type"/> for <see cref="Int64"/>.
      /// </summary>
      ...
      /// <param name="result">The bound value, an instance of <see cref="Int64"/>.</param>
      ...
      public override bool TryBind(string value, IFormatProvider provider, out object result) {
         ...
         if (!Int64.TryParse(value, NumberStyles.AllowLeadingSign, provider, out parsedResult)) {
            return false;
         }
